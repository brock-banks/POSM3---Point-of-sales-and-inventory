...
// Aggregate balances from customer_transactions
$sql = "
    SELECT
        c.id,
        c.name,
...
<div class="row gy-3">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <h4 class="mb-0">Customer Balances</h4>
        <a href="/POSM3/public/customer_ledger.php" class="btn btn-sm btn-outline-light">
    ...
    <div class="col-12">
        <div class="card bg-white border-0 shadow-sm">
            <div class="card-body">
                ...
                <?php if (empty($rows)): ?>
                    <p class="text-muted mb-0">No customers or no transactions yet.</p>
                <?php else: ?>
                        ...
                        <table class="table table-white table-sm align-middle mb-0">
                            ...
                            <?php foreach ($rows as $r): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="/POSM3/public/customer_ledger.php?customer_id=<?= (int)$r['id'] ?>"
