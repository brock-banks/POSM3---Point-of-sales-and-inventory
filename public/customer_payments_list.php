...
<div class="row gy-3">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <a href="/POSM3/public/customer_payment_new.php" class="btn btn-sm btn-primary">
            + New Payment
        </a>
    </div>
    ...
    <div class="col-12">
        <form class="row g-2 mb-3" method="get">
            <div class="col-sm-6 col-md-4 col-lg-3">
                <label class="form-label form-label-sm">Filter by customer</label>
